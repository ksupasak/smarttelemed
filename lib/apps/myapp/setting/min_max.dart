        ...
        children: [
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("SYS", style: TextStyle(fontSize: width * 0.03)),
              ),
              Text("min", style: TextStyle(fontSize: width * 0.03)),
              SizedBox(
                width: width * 0.3,
                child: TextField(
              ...
              Text("max", style: TextStyle(fontSize: width * 0.03)),
              SizedBox(
                width: width * 0.3,
                child: TextField(
                  keyboardType: TextInputType.number,
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("DIS", style: TextStyle(fontSize: width * 0.03)),
              ),
              Text("min", style: TextStyle(fontSize: width * 0.03)),
              SizedBox(
                width: width * 0.3,
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("TEMP", style: TextStyle(fontSize: width * 0.03)),
              ),
              Text("min", style: TextStyle(fontSize: width * 0.03)),
              SizedBox(
                width: width * 0.3,
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("SPO2", style: TextStyle(fontSize: width * 0.03)),
              ),
              Text("min", style: TextStyle(fontSize: width * 0.03)),
              SizedBox(
                width: width * 0.3,
          ...
          Row(
            children: [
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("BMI", style: TextStyle(fontSize: width * 0.03)),
              ),
              Text("min", style: TextStyle(fontSize: width * 0.03)),
              SizedBox(
                width: width * 0.3,
