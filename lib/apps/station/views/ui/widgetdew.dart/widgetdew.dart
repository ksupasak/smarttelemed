          ...
          children: [
            SizedBox(
              child: Column(
                ...
                children: [
                  const Row(children: [WidgetNameHospital()]),
              ...
              child: Row(
                ...
                children: [
                  SizedBox(
                    width: width * 0.3,
                    height: height * 0.03,
                    child: Row(children: [Text(data.toString(), style: style)]),
                  ),
                ],
              ),
            ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(blurRadius: 2, offset: Offset(0.5, 2), color: Colors.grey),
        ],
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return resTojson != null
        ? resTojson["queue_number"] != ""
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                BoxWidetdew(
                                  ...
                                  radius: 10.0,
                                  fontSize: 0.025,
                                  text: resTojson['wait_list'].length
                                      .toString(),
              ...
              : Container(child: Text(resTojson["queue_number"]))
        : Container(
...
class _BoxRunQueue2State extends State<BoxRunQueue2> {
  ...
  Future<void> get_queue() async {
    try {
      ...
      var res = await http.post(
        url,
        body: {'care_unit_id': context.read<DataProvider>().care_unit_id},
      );
      setState(() {
        resTojson = json.decode(res.body);
      });
              ...
              ? resTojson['completes'].length != 0
                    ...
                    : Center(
                        child: Container(
                          width: _width * 0.7,
                          child: Center(
                            child: Text("ยังไม่เรียก", style: style),
                          ),
                        ),
                      )
              : Row(
                          ...
                          child: Row(
                            children: [
                              Container(
                                width: _width * 0.1,
                                child: Center(
                                  child: Text('กำลังรอ', style: style),
                                ),
                              ),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Center(
                                        child: Text(
                                          resTojson['appointments'][index]['date'],
                                          style: style,
                                        ),
                                      ),
                                    ),
                                    Container(
                                      ...
                                      child: Center(
                                        child: Text(
                                          resTojson['appointments'][index]['slot'],
                                          style: style,
                                        ),
                                      ),
                                    ),
                                    Container(
                                      ...
                                      child: Center(
                                        child: Text(
                                          resTojson['appointments'][index]['care_name'],
                                          style: style,
                                        ),
                                      ),
                                    ),
                                    Container(
                                      ...
                                      child: Center(
                                        child: Text(
                                          resTojson['appointments'][index]['doctor_name'],
                                          style: style,
                                        ),
                                      ),
                                    ),
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: Color.fromARGB(255, 255, 255, 255),
          boxShadow: [
            BoxShadow(blurRadius: 10.0, color: Color.fromARGB(255, 63, 86, 83)),
          ],
        ),
        child: Padding(
          padding: const EdgeInsets.all(8.0),
...
class _BoxTextState extends State<BoxText> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.text == null
        ? Text('')
        : Center(child: Text(widget.text.toString(), style: style));
  }
}
...
class _BoxToDayState extends State<BoxToDay> {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle styletext2 = TextStyle(
      ...
      color: Color(0xff00A3FF),
      shadows: [
        Shadow(color: Colors.grey, offset: Offset(0, 2), blurRadius: 4),
      ],
      fontSize: _width * 0.05,
    );
    TextStyle styletext5 = TextStyle(
...
class _BoxStatusinformState extends State<BoxStatusinform> {
  ...
  Future<void> get_finished() async {
    var url = Uri.parse(
      '${context.read<DataProvider>().platfromURL}/finish_appoint',
    );
    var res = await http.post(
      url,
      body: {'public_id': context.read<DataProvider>().id},
