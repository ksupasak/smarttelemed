...
import 'package:smarttelemed/apps/station/views/pages/numpad.dart';
...
import 'package:smarttelemed/apps/station/test/esm_idcard.dart';
...
class _HomeappState extends State<Homeapp> {
  ...
  void initState() {
    setState(() {
      ...
      context.read<DataProvider>().updateuserinformation({
        "pid": "",
        "claimTypes": "[]",
      });
