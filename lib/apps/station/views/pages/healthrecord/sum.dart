    ...
    if (data != []) {
      for (RecordSnapshot<int, Map<String, Object?>> record in data) {
        ...
        context.read<DataProvider>().datamin_max['maxsys'] = record["maxsys"]
            .toString();
        context.read<DataProvider>().datamin_max['minspo2'] = record["minspo2"]
            .toString();
        context.read<DataProvider>().datamin_max['maxspo2'] = record["maxspo2"]
            .toString();
        context.read<DataProvider>().datamin_max['mindia'] = record["mindia"]
            .toString();
        context.read<DataProvider>().datamin_max['maxdia'] = record["maxdia"]
            .toString();

        context.read<DataProvider>().datamin_max['mintemp'] = record["mintemp"]
            .toString();
        context.read<DataProvider>().datamin_max['maxtemp'] = record["maxtemp"]
            .toString();
        context.read<DataProvider>().datamin_max['minbmi'] = record["minbmi"]
            .toString();
        context.read<DataProvider>().datamin_max['maxbmi'] = record["maxbmi"]
            .toString();
      }
    }
    setState(() {});
