...
class _UserInformation2State extends State<UserInformation2> {
  ...
  Future<void> finished() async {
    ...
    await http.post(url, body: {'public_id': context.read<DataProvider>().id});
  }
  ...
  void printexam() async {
    ...
    pw.Widget _buildHeader() {
      return pw.Column(
        ...
        children: [
          pw.Text('ผลการตรวจ', style: font_sizeBody),
    ...
    pw.Widget _buildDocnote() {
      return pw.Column(
        ...
        children: [
          ...
          pw.Text('จ่ายยา', style: font_sizeBody),
          pw.Text(doctor_note, style: font_sizeBody),
          pw.Text('รายละเอียด', style: font_sizeBody),
            ...
            Positioned(
              child: ListView(
                children: [
                                                ...
                                                children: [
                                                  ElevatedButton(
                                                    ...
                                                    onPressed: () {
                                                      ...
                                                      if (resTojsonGateway !=
                                                          null) {
                                                        if (resTojsonGateway["statuscode"] ==
                                                            100) {}
                                                      }
                                                    },
                                                    child: Padding(
                  ...
                  SizedBox(
                    height: height * 0.15,
                    child: Column(children: [choice(cancel: stop)]),
                  ),
                ],
              ),
            ),
    ...
    if (resTojson['health_records'].length == 0) {
      ...
      if (res.statusCode == 200) {
        ...
        setState(() {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const UserInformation2()),
          );
        });
      }
    }
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Center(child: Text('การนัดหมาย', style: style)),
                  ],
                ),
              ),
            ),
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Center(child: Text('ประวัติสุขภาพ', style: style)),
                  ],
                ),
              ),
            ),
