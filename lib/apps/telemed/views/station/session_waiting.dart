...
class SessionWaiting extends StatefulWidget {
  const SessionWaiting({super.key});

  @override
  State<SessionWaiting> createState() => _SessionWaitingState();
}

class _SessionWaitingState extends State<SessionWaiting> {
  Timer? timerCheck;
  var resToJson;
  var resToJsonVideo;
