        ...
        child: ListView(
          children: [
            ...
            Row(
              ...
              children: [
                Text(
                  "Require Id Card",
                  style: TextStyle(
                    color: isSwitchedINHospital ? Colors.black : Colors.grey,
                    fontSize: width * 0.04,
                  ),
                ),
                Switch(
            ...
            SizedBox(
              child: Column(
                children: [
                  Text("text_no_hn", style: TextStyle(fontSize: width * 0.04)),
                  TextField(
            ...
            SizedBox(
              child: Column(
                children: [
                  Text("text_no_vn", style: TextStyle(fontSize: width * 0.04)),
                  TextField(
